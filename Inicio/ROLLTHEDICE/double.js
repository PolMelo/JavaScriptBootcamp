...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const apuestaNumero = document.getElementById("apuestaNumero");
    const apuestaTipo = document.getElementById("apuestaTipo");
    //Registrar clases per treure anuimacio
    const dado1 = document.getElementById('doble1');
    const dado2 = document.getElementById('doble2');
...
`;
    ...
    let apuestaValor = null;
    let apuestaTipoValor = null;
    if (apuestaForm) {
